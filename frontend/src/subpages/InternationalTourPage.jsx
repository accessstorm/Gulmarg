...
import './InternationalTourPage.css';

const InternationalTourPage = ({ destinationType, tourData }) => {
    if (!tourData) {
        return <div>Error: Tour data not found for destination: {destinationType}</div>;
    }

    return (
        <div className="international-tour-page-content home-page-content">
            <div className="container">
                <header className="international-tour-header">
                    ...
                    <div className="header-content">
                        ...
                        <p><a href="/">Home</a> / International Tours / {tourData.pageTitle.replace(' Tour', '')}</p>
                    </div>
                </header>
                ...
                <section className="tour-links-section">
                    <div className="tour-links-grid">
                        <div className="tour-link-card">{tourData.pageTitle} Tours</div> {/* Example - adjust as needed */}
                        <div className="tour-link-card">{tourData.pageTitle} Packages</div> {/* Example - adjust as needed */}
                        <div className="tour-link-card">More {tourData.pageTitle} Info</div> {/* Example - adjust as needed */}
                        {/* Add more link cards if needed, dynamically or statically */}
                    </div>
                </section>
                ...
                <section className="tour-packages-section">
                    ...
                    {/* You can add package cards or lists here if you have specific package details in your JSON */}
                </section>
